...
const (
	...
	lintRunValueByCodeKey = "dzce.lint.by_code"
)
...
// LintRulesProvider registers dzce diagnostic rules into RuleRegistrar.
...
// RegisterLintRules registers stable dzce diagnostic rules into registrar.
...
// RegisterLintRulesByScope registers dzce rules filtered by scope tokens.
...
// RegisterLintRulesByStage registers dzce rules filtered by stage tokens.
